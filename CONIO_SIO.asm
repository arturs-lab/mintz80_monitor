...
;***************************************************************************
;PRINT_STRING_SP
;Function: Prints string to terminal program. Start on stack
;***************************************************************************
CON_PRT_STR_SP:	JP    SIOA_PRNT_SP
        
;***************************************************************************
;PRINT_STRING
;Function: Prints string to terminal program. Start in HL
;***************************************************************************
CON_PRT_STR:	JP    SIOA_PRNT_STR
        
;***************************************************************************
;CON_PRT_CHAR
;Function: Get upper case ASCII character from Accumulator to UART
;***************************************************************************
CON_PRT_CHAR:	JP SIOA_TX    ;Echo character to terminal
...
;***************************************************************************
CON_GET_CHAR:	CALL    SIOA_RX         ;Get char into Acc
