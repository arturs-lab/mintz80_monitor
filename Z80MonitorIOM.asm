...
VERSMIN:    EQU     '7'
            ...
            INCLUDE CONSTANTS_IOM.asm ; copy or edit one of the 
...
MNMSG2:     DEFB    0DH, 0Ah, ' adaptation to MPF-1Plus / IOM-MPF-IP', 09h, '2023 F.J.Kraan', 0Dh, 0Ah, EOS
MNMSG3:     DEFB    'Monitor v', VERSMYR, '.', VERSMIN, 
            DEFB    ' ROM: ', ROMB1, ROMB2, ROMB3, ROMB4
            DEFB    'h P8251A: ', UART1, UART2, 'h', 0Dh, 0AH, 0Dh, 0AH, EOS
